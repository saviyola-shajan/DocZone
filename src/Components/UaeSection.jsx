      ...
      <div className="w-full md:w-1/2 p-2 sm:p-4 md:p-6 flex flex-col justify-center">
        <h1
          className={`text-3xl sm:text-4xl md:text-5xl font-medium ${
            isDarkBg ? "text-white" : "text-[#0E142A]"
          }`}
        >
          Unblocking
        </h1>
        <h3
          className={`text-xl sm:text-2xl md:text-3xl font-normal mt-2 ${
            isDarkBg ? "text-white" : "text-[#0E142A]"
          }`}
        >
        ...
        <p
          className={`mt-4 text-base sm:text-lg font-normal mb-6 ${
            isDarkBg ? "text-white" : "text-[#0E142A]"
          }`}
        >
        ...
        <Link
          to="/contact"
          className="group relative transition-all duration-300 text-[#000000] text-sm sm:text-base md:text-lg px-4 py-2 rounded-full border border-[#22EEBF] hover:bg-[#ffffff]  bg-[#22EEBF] font-medium flex items-center justify-between w-[70%] sm:w-[50%] md:w-[40%]"
        >
          Connect Us
