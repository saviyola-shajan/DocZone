...
function FastAndQuality() {
  return (
    <div className="min-h-screen px-6 sm:px-10 md:px-16 lg:px-20 xl:px-24 py-10 sm:py-14 md:py-16 lg:py-20 flex flex-col lg:flex-row">
      <div className="w-full lg:w-2/5 relative mb-8 lg:mb-0">
      ...
      <div className="w-full lg:w-3/5 text-[#FFFFFF] p-4">
        ...
        <h4 className="text-lg sm:text-xl font-medium mt-10">Our mission is clear: </h4>
