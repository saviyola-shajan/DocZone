...
function MissionVision() {
  return (
    <div className="p-24 bg-[#FFFFFF] min-h-screen">
      <div className="flex items-center justify-between mb-16">
        <div className="w-1/2 pr-8">
          <h1 className="text-5xl font-medium text-[#0E1834]">Vision</h1>
          <p className="mt-4 text-[#161616] text-lg font-normal text-justify">
        ...
        <div className="w-1/2 flex justify-center">
          <img
            src={visioimg}
            alt="Vision Image"
            className="w-[90%] h-96 rounded-lg"
          />
        </div>
      </div>
      <div className="flex items-center justify-between">
        ...
        <div className="w-1/2 pl-8">
          <h1 className="text-5xl font-medium text-[#008364]">Mission</h1>
          <p className="mt-4 text-[#161616] text-lg font-normal text-justify">
            Our goal is to ensure that each client interaction results in a
            successful outcome, thereby building trust and fostering long-term
            relationships. By continuously refining our processes and staying
